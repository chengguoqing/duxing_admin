...
router.post("/liaotian", function (req, res, next) {

    let sd_Dweer = {}
    sd_Dweer.content = req.body.text
    sd_Dweer = JSON.stringify(sd_Dweer)

//    console.log("http://bingyu.puahs.com/app/getTextJokeDetail?content=" + req.body.text);
//     
       request.post('http://bingyu.puahs.com/app/getTextJokeDetail', {form:{content:req.body.text}},function(a,b,c){
...
//    request({
//        url: "http://bingyu.puahs.com/app/getTextJokeDetail",
//        body: sd_Dweer,
//        headers:{
